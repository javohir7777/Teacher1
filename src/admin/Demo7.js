...
import { appointments } from './demo-data/grouping2';

const isWeekOrMonthView = viewName => viewName === 'Week' || viewName === 'Month';

const priorityData = [
  { text: 'Zohidova Odina', id: 1, color: lightBlue },
  { text: 'Raximov Asilbek', id: 2, color: green },
];
...
export default class Demo6 extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
